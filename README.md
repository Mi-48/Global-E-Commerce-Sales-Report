...
- Delivered a professional BI report that communicates results clearly to stakeholders.
...
### Trends Over Time
- Sales and profit are tracked across **2023–2025**, with monthly breakdowns.  
- Profit margins fluctuate between **30–36%** depending on the month.  

### Regional Performance
- Regions analyzed: **Asia Pacific, Europe, Middle East & Africa, North America, South America**.  
- **North America** leads with ~$192.7K in sales (≈40% of total).  
- **Asia Pacific** follows with ~$143.1K in sales (≈30%).  

### Product Categories
- **Furniture:** $256K sales, ~31% margin.  
- **Technology:** $139.5K sales, ~34.5% margin.  
- **Clothing & Accessories:** $69.4K sales, ~37% margin (highest margin).  
- **Office Supplies:** $19.4K sales, ~15% margin (lowest margin).  

### Customer Segments
- **Consumer:** $256K sales, 34% margin.  
- **Corporate:** $146K sales, 30% margin.  
- **Home Office:** $82K sales, 33% margin.  

### Product-Level Insights
- Top profit-generating items:  
  - Ergonomic Office Chair ($15.1K profit)  
  - Standing Desk Converter ($14.7K)  
  - Corner L-Shaped Desk ($13.7K)  
- Lowest margin items: Neon Highlighters and Paper Clips (negative margins).  

### Payment & Shipping
- Payment methods: **Credit Card (39.8%)**, PayPal (15.9%), others smaller shares.  
- Shipping cost bands show profitability concentrated in mid-range costs ($6–$20).  
